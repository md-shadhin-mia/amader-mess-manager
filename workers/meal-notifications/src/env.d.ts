/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example src/env.d.ts` (hash: 3b60bc9470db067826b2899519b3a025)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIREBASE_PROJECT_ID" | "APP_URL" | "GOOGLE_SERVICE_ACCOUNT_JSON">> {}
}
